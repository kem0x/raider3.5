...
{
	static auto fn = UObject::FindObject<UFunction>("Function AnimNotify_HideBodyOnDeath.AnimNotify_HideBodyOnDeath_C.Received_Notify");

	UAnimNotify_HideBodyOnDeath_C_Received_Notify_Params params;
