...
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_NPC_Elemental_Lightning.GC_NPC_Elemental_Lightning_C.UserConstructionScript");

	AGC_NPC_Elemental_Lightning_C_UserConstructionScript_Params params;
