...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.InitCampfireEffects");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.HealTicks");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.OnRep_IsActive");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.UserConstructionScript");

	ATrap_Floor_Player_Campfire_C_UserConstructionScript_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.OnReloadEnd");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.OnPlaced");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.OnFinishedBuilding");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.GameplayCue.Abilities.Activation.Traps.ReloadBegin");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.GameplayCue.Abilities.Activation.Traps.ActivateTrap");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.OnOutOfDurability");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.TriggerLaunchEffects");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Trap_Floor_Player_Campfire.Trap_Floor_Player_Campfire_C.ExecuteUbergraph_Trap_Floor_Player_Campfire");
