...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCNS_GM_PlayerOnDmgLifeLeech.GCNS_GM_PlayerOnDmgLifeLeech_C.OnStartParticleSystemSpawned");

	UGCNS_GM_PlayerOnDmgLifeLeech_C_OnStartParticleSystemSpawned_Params params;
