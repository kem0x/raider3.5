...
public:
	...
	unsigned char                                      UnknownData01[0xC8];                                      // 0x01A0(0x00C8) MISSED OFFSET
	float                                              OutgoingDuration;                                         // 0x0268(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              IncomingDuration;                                         // 0x026C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x28];                                      // 0x0270(0x0028) MISSED OFFSET
	TArray<struct FString>                             ClientDebugStrings;                                       // 0x0298(0x0010) (Net, ZeroConstructor)
	TArray<struct FString>                             ServerDebugStrings;                                       // 0x02A8(0x0010) (Net, ZeroConstructor)
	struct FGameplayAbilitySpecContainer               ActivatableAbilities;                                     // 0x02B8(0x00C8) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData03[0x50];                                      // 0x0380(0x0050) MISSED OFFSET
	TArray<class UGameplayAbility*>                    AllReplicatedInstancedAbilities;                          // 0x03D0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x338];                                     // 0x03E0(0x0338) MISSED OFFSET
	TArray<class AGameplayAbilityTargetActor*>         SpawnedTargetActors;                                      // 0x0718(0x0010) (ZeroConstructor)
	struct FGameplayAbilityRepAnimMontage              RepAnimMontageInfo;                                       // 0x0728(0x0030) (Net)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0758(0x0008) MISSED OFFSET
	struct FGameplayAbilityLocalAnimMontage            LocalAnimMontageInfo;                                     // 0x0760(0x0030)
	unsigned char                                      UnknownData06[0xB8];                                      // 0x0790(0x00B8) MISSED OFFSET
	class AActor*                                      OwnerActor;                                               // 0x0848(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      AvatarActor;                                              // 0x0850(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x18];                                      // 0x0858(0x0018) MISSED OFFSET
	struct FActiveGameplayEffectsContainer             ActiveGameplayEffects;                                    // 0x0870(0x0428) (Net)
	struct FActiveGameplayCueContainer                 ActiveGameplayCues;                                       // 0x0C98(0x00D0) (Net)
	struct FActiveGameplayCueContainer                 MinimalReplicationGameplayCues;                           // 0x0D68(0x00D0) (Net)
	unsigned char                                      UnknownData08[0x128];                                     // 0x0E38(0x0128) MISSED OFFSET
	TArray<unsigned char>                              BlockedAbilityBindings;                                   // 0x0F60(0x0010) (Net, ZeroConstructor, Transient)
	unsigned char                                      UnknownData09[0x128];                                     // 0x0F70(0x0128) MISSED OFFSET
	struct FMinimalReplicationTagCountMap              MinimalReplicationTags;                                   // 0x1098(0x0060) (Net)
	unsigned char                                      UnknownData10[0x10];                                      // 0x10F8(0x0010) MISSED OFFSET
	struct FReplicatedPredictionKeyMap                 ReplicatedPredictionKeyMap;                               // 0x1108(0x00C0) (Net)
...
public:
	...
	struct FSoftObjectPath                             GlobalCurveTableName;                                     // 0x0120(0x0018) (Config)
	struct FSoftObjectPath                             GlobalAttributeMetaDataTableName;                         // 0x0138(0x0018) (Config)
	struct FSoftObjectPath                             GlobalAttributeSetDefaultsTableName;                      // 0x0150(0x0018) (Config)
	TArray<struct FSoftObjectPath>                     GlobalAttributeSetDefaultsTableNames;                     // 0x0168(0x0010) (ZeroConstructor, Config)
	struct FSoftObjectPath                             GlobalGameplayCueManagerClass;                            // 0x0178(0x0018) (Config)
	struct FSoftObjectPath                             GlobalGameplayCueManagerName;                             // 0x0190(0x0018) (Config)
	TArray<struct FString>                             GameplayCueNotifyPaths;                                   // 0x01A8(0x0010) (ZeroConstructor, Config)
	struct FSoftObjectPath                             GameplayTagResponseTableName;                             // 0x01B8(0x0018) (Config)
	class UGameplayTagReponseTable*                    GameplayTagResponseTable;                                 // 0x01D0(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               PredictTargetGameplayEffects;                             // 0x01D8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x01D9(0x0007) MISSED OFFSET
	class UCurveTable*                                 GlobalCurveTable;                                         // 0x01E0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UCurveTable*>                         GlobalAttributeDefaultsTables;                            // 0x01E8(0x0010) (ZeroConstructor)
	class UDataTable*                                  GlobalAttributeMetaDataTable;                             // 0x01F8(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UAbilitySystemComponent*                     AbilitySystemComponent;                                   // 0x03C8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
public:
	...
	bool                                               bMarkPendingKillOnAbilityEnd;                             // 0x0439(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x6];                                       // 0x043A(0x0006) MISSED OFFSET
...
{
public:
	bool                                               ShouldProduceTargetDataOnServer;                          // 0x0328(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0329(0x0007) MISSED OFFSET
	struct FGameplayAbilityTargetingLocationInfo       StartLocation;                                            // 0x0330(0x0070) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData01[0x30];                                      // 0x03A0(0x0030) MISSED OFFSET
	class APlayerController*                           MasterPC;                                                 // 0x03D0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UGameplayAbility*                            OwningAbility;                                            // 0x03D8(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bDestroyOnConfirmation;                                   // 0x03E0(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x03E1(0x0007) MISSED OFFSET
	class AActor*                                      SourceActor;                                              // 0x03E8(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	struct FWorldReticleParameters                     ReticleParams;                                            // 0x03F0(0x000C) (BlueprintVisible)
	unsigned char                                      UnknownData03[0x4];                                       // 0x03FC(0x0004) MISSED OFFSET
	class UClass*                                      ReticleClass;                                             // 0x0400(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGameplayTargetDataFilterHandle             Filter;                                                   // 0x0408(0x0010) (BlueprintVisible, Net)
	bool                                               bDebug;                                                   // 0x0418(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x17];                                      // 0x0419(0x0017) MISSED OFFSET
	class UAbilitySystemComponent*                     GenericDelegateBoundASC;                                  // 0x0430(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FCollisionProfileName                       TraceProfile;                                             // 0x0440(0x0008) (Edit, BlueprintVisible, Config)
	bool                                               bTraceAffectsAimPitch;                                    // 0x0448(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x0449(0x0017) MISSED OFFSET
...
{
public:
	class UMaterialInterface*                          PlacedActorMaterial;                                      // 0x0480(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FWorldReticleParameters                     Parameters;                                               // 0x0328(0x000C) (Edit, BlueprintVisible, DisableEditOnTemplate)
	bool                                               bFaceOwnerFlat;                                           // 0x0334(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSnapToTargetedActor;                                     // 0x0335(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetValid;                                           // 0x0336(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetAnActor;                                         // 0x0337(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class APlayerController*                           MasterPC;                                                 // 0x0338(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AActor*                                      TargetingActor;                                           // 0x0340(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCapsuleComponent*                           CollisionComponent;                                       // 0x0348(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<class UActorComponent*>                     VisualizationComponents;                                  // 0x0350(0x0010) (ExportObject, ZeroConstructor)
...
public:
	...
	struct FGameplayCueObjectLibrary                   RuntimeGameplayCueObjectLibrary;                          // 0x0048(0x0058) (Transient)
	struct FGameplayCueObjectLibrary                   EditorGameplayCueObjectLibrary;                           // 0x00A0(0x0058) (Transient)
	unsigned char                                      UnknownData01[0x1B8];                                     // 0x00F8(0x01B8) MISSED OFFSET
...
{
public:
	bool                                               bAutoDestroyOnRemove;                                     // 0x0328(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0329(0x0003) MISSED OFFSET
	float                                              AutoDestroyDelay;                                         // 0x032C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfTimelineIsStillRunning;                             // 0x0330(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfLatentActionIsStillRunning;                         // 0x0331(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x0332(0x0006) MISSED OFFSET
	struct FGameplayTag                                GameplayCueTag;                                           // 0x0338(0x0008) (Edit, DisableEditOnInstance)
	struct FGameplayTagReferenceHelper                 ReferenceHelper;                                          // 0x0340(0x0010) (Edit)
	struct FName                                       GameplayCueName;                                          // 0x0350(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bAutoAttachToOwner;                                       // 0x0358(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsOverride;                                               // 0x0359(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerInstigator;                             // 0x035A(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerSourceObject;                           // 0x035B(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleOnActiveEvents;                             // 0x035C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleWhileActiveEvents;                          // 0x035D(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x035E(0x0002) MISSED OFFSET
	int                                                NumPreallocatedInstances;                                 // 0x0360(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x34];                                      // 0x0364(0x0034) MISSED OFFSET
