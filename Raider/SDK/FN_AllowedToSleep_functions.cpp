...
{
	static auto fn = UObject::FindObject<UFunction>("Function AllowedToSleep.AllowedToSleep_C.PerformConditionCheckAI");

	UAllowedToSleep_C_PerformConditionCheckAI_Params params;
