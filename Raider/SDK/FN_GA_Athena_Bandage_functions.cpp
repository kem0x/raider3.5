...
{
	static auto fn = UObject::FindObject<UFunction>("Function GA_Athena_Bandage.GA_Athena_Bandage_C.K2_OnEndAbility");

	UGA_Athena_Bandage_C_K2_OnEndAbility_Params params;
