...
{
	static auto fn = UObject::FindObject<UFunction>("Function GA_Athena_Shields.GA_Athena_Shields_C.K2_OnEndAbility");

	UGA_Athena_Shields_C_K2_OnEndAbility_Params params;
