...
public:
	...
	TArray<class UReplicationGraphNode*>               GlobalGraphNodes;                                         // 0x00C0(0x0010) (ZeroConstructor)
	TArray<class UReplicationGraphNode*>               PrepareForReplicationNodes;                               // 0x00D0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x220];                                     // 0x00E0(0x0220) MISSED OFFSET
