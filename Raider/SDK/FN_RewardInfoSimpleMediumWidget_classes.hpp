...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass RewardInfoSimpleMediumWidget.RewardInfoSimpleMediumWidget_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_RewardInfoSimpleMediumWidget(int EntryPoint);
};
