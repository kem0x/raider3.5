...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCL_MedicPack_FuelRegen.GCL_MedicPack_FuelRegen_C.UserConstructionScript");

	AGCL_MedicPack_FuelRegen_C_UserConstructionScript_Params params;
