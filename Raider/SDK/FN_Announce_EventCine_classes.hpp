...
public:
	...
	class UMediaSource*                                EventMediaSource;                                         // 0x03A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	class UFortMediaSubtitlesPlayer*                   EventSubtitlesPlayer;                                     // 0x03B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
