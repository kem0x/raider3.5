...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DA_EyeOfTheStormTracker.DA_EyeOfTheStormTracker_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_DA_EyeOfTheStormTracker(int EntryPoint);
};
