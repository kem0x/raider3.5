...
{
	static auto fn = UObject::FindObject<UFunction>("Function BacchusControlsHelp.BacchusControlsHelp_C.Update");

	UBacchusControlsHelp_C_Update_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BacchusControlsHelp.BacchusControlsHelp_C.OnActivated");

	UBacchusControlsHelp_C_OnActivated_Params params;
