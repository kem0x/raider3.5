...
bool AGC_NPC_Elemental_Fire_C::WhileActive(class AActor** MyTarget, struct FGameplayCueParameters* Parameters)
{
	static auto fn = UObject::FindObject<UFunction>("Function GC_NPC_Elemental_Fire.GC_NPC_Elemental_Fire_C.WhileActive");

	AGC_NPC_Elemental_Fire_C_WhileActive_Params params;
