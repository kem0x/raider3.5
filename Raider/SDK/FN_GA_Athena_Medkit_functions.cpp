...
{
	static auto fn = UObject::FindObject<UFunction>("Function GA_Athena_Medkit.GA_Athena_Medkit_C.K2_OnEndAbility");

	UGA_Athena_Medkit_C_K2_OnEndAbility_Params params;
