...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GE_Constructor_FeelTheBase_StackCountTag_Overflow.GE_Constructor_FeelTheBase_StackCountTag_Overflow_C");
		return ptr;
	}
