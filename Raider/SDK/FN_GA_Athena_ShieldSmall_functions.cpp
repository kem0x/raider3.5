...
{
	static auto fn = UObject::FindObject<UFunction>("Function GA_Athena_ShieldSmall.GA_Athena_ShieldSmall_C.K2_OnEndAbility");

	UGA_Athena_ShieldSmall_C_K2_OnEndAbility_Params params;
