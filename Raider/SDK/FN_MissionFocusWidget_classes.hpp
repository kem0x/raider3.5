...
public:
	...
	class UFortMissionTimerComponent*                  SavedTimerComponent;                                      // 0x0230(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
