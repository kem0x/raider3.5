...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Athena_PlayerCameraModeTargetingLauncherRCRocket.Athena_PlayerCameraModeTargetingLauncherRCRocket_C");
		return ptr;
	}
