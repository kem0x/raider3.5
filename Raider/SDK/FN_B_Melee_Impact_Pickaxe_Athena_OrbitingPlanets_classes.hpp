...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_Melee_Impact_Pickaxe_Athena_OrbitingPlanets.B_Melee_Impact_Pickaxe_Athena_OrbitingPlanets_C");
		return ptr;
	}
