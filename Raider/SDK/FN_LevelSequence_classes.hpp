...
public:
	...
	struct FLevelSequenceBindingReferences             BindingReferences;                                        // 0x03A0(0x0050)
	TMap<struct FString, struct FLevelSequenceObject>  PossessedObjects;                                         // 0x03F0(0x0050) (ZeroConstructor, Deprecated)
