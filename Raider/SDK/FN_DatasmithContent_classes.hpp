...
public:
	...
	struct FDatasmithPostProcessSettingsTemplate       PostProcessSettings;                                      // 0x0040(0x0030)
...
public:
	...
	EDatasmithImportAssetConflictPolicy                ActorConflictPolicy;                                      // 0x002B(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	EDatasmithImportAssetConflictPolicy                LightConflictPolicy;                                      // 0x002C(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	EDatasmithImportAssetConflictPolicy                CameraConflictPolicy;                                     // 0x002D(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	EDatasmithImportMaterialQuality                    MaterialQuality;                                          // 0x002E(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x002F(0x0001) MISSED OFFSET
	struct FDatasmithImportBaseOptions                 BaseOptions;                                              // 0x0030(0x0018) (Edit, BlueprintVisible, Config)
	struct FDatasmithTessellationOptions               TessellationOptions;                                      // 0x0048(0x000C) (Edit, BlueprintVisible, Config)
	unsigned char                                      UnknownData01[0x2C];                                      // 0x0054(0x002C) MISSED OFFSET
...
{
public:
	class UDatasmithSceneImportData*                   Scene;                                                    // 0x0328(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
