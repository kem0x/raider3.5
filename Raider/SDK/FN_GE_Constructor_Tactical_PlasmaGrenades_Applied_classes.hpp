...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GE_Constructor_Tactical_PlasmaGrenades_Applied.GE_Constructor_Tactical_PlasmaGrenades_Applied_C");
		return ptr;
	}
