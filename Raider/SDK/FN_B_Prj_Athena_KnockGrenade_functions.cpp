...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_Prj_Athena_KnockGrenade.B_Prj_Athena_KnockGrenade_C.LaunchVehicle");

	AB_Prj_Athena_KnockGrenade_C_LaunchVehicle_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_Prj_Athena_KnockGrenade.B_Prj_Athena_KnockGrenade_C.BndEvt__CapsuleComponent_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature");

	AB_Prj_Athena_KnockGrenade_C_BndEvt__CapsuleComponent_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature_Params params;
