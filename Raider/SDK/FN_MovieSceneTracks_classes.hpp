...
{
public:
	struct FMovieSceneFloatChannel                     TimingCurve;                                              // 0x0108(0x0090) (Edit)
	EMovieScene3DPathSection_Axis                      FrontAxisEnum;                                            // 0x0198(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EMovieScene3DPathSection_Axis                      UpAxisEnum;                                               // 0x0199(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x019A(0x0002) MISSED OFFSET
	unsigned char                                      bFollow : 1;                                              // 0x019C(0x0001) (Edit)
	unsigned char                                      bReverse : 1;                                             // 0x019C(0x0001) (Edit)
	unsigned char                                      bForceUpright : 1;                                        // 0x019C(0x0001) (Edit)
...
// 0x05B0 (0x0690 - 0x00E0)
class UMovieScene3DTransformSection : public UMovieSceneSection
{
public:
	struct FMovieSceneTransformMask                    TransformMask;                                            // 0x00E0(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00E4(0x0004) MISSED OFFSET
	struct FMovieSceneFloatChannel                     Translation[0x3];                                         // 0x00E8(0x0090)
	struct FMovieSceneFloatChannel                     Rotation[0x3];                                            // 0x0298(0x0090)
	struct FMovieSceneFloatChannel                     Scale[0x3];                                               // 0x0448(0x0090)
	struct FMovieSceneFloatChannel                     ManualWeight;                                             // 0x05F8(0x0090)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0688(0x0004) MISSED OFFSET
	bool                                               bUseQuaternionInterpolation;                              // 0x068C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FMovieSceneActorReferenceData               ActorReferenceData;                                       // 0x00E0(0x0098)
	struct FIntegralCurve                              ActorGuidIndexCurve;                                      // 0x0178(0x0070) (Deprecated)
	TArray<struct FString>                             ActorGuidStrings;                                         // 0x01E8(0x0010) (ZeroConstructor, Deprecated)
...
public:
	...
	struct FMovieSceneFloatChannel                     SoundVolume;                                              // 0x00F8(0x0090) (Edit)
	struct FMovieSceneFloatChannel                     PitchMultiplier;                                          // 0x0188(0x0090) (Edit)
	...
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0228(0x0010) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FMovieSceneBoolChannel                      BoolCurve;                                                // 0x00E8(0x0088)
...
{
public:
	struct FMovieSceneByteChannel                      ByteCurve;                                                // 0x00E0(0x0090)
...
{
public:
	struct FMovieSceneFloatChannel                     RedCurve;                                                 // 0x00E0(0x0090)
	struct FMovieSceneFloatChannel                     GreenCurve;                                               // 0x0170(0x0090)
	struct FMovieSceneFloatChannel                     BlueCurve;                                                // 0x0200(0x0090)
	struct FMovieSceneFloatChannel                     AlphaCurve;                                               // 0x0290(0x0090)
...
{
public:
	struct FMovieSceneByteChannel                      EnumCurve;                                                // 0x00E0(0x0090)
...
public:
	...
	struct FMovieSceneEventSectionData                 EventData;                                                // 0x0148(0x0080)
...
{
public:
	struct FMovieSceneFloatChannel                     FloatCurve;                                               // 0x00E0(0x0090)
...
{
public:
	struct FLinearColor                                FadeColor;                                                // 0x0170(0x0010) (Edit, IsPlainOldData)
	unsigned char                                      bFadeAudio : 1;                                           // 0x0180(0x0001) (Edit)
...
{
public:
	struct FMovieSceneIntegerChannel                   IntegerCurve;                                             // 0x00E0(0x0088)
...
{
public:
	struct FMovieSceneParticleChannel                  ParticleKeys;                                             // 0x00E0(0x0090)
...
{
public:
	struct FMovieSceneSkeletalAnimationParams          Params;                                                   // 0x00E0(0x00B0) (Edit)
	class UAnimSequence*                               AnimSequence;                                             // 0x0190(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UAnimSequenceBase*                           Animation;                                                // 0x0198(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              StartOffset;                                              // 0x01A0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              EndOffset;                                                // 0x01A4(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x01A8(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      bReverse : 1;                                             // 0x01AC(0x0001) (Deprecated)
	unsigned char                                      UnknownData00[0x3];                                       // 0x01AD(0x0003) MISSED OFFSET
	struct FName                                       SlotName;                                                 // 0x01B0(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	struct FMovieSceneStringChannel                    StringCurve;                                              // 0x00E0(0x0098)
...
// 0x0248 (0x0328 - 0x00E0)
class UMovieSceneVectorSection : public UMovieSceneSection
{
public:
	struct FMovieSceneFloatChannel                     Curves[0x4];                                              // 0x00E0(0x0090)
	int                                                ChannelsUsed;                                             // 0x0320(0x0004) (ZeroConstructor, IsPlainOldData)
