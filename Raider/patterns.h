...
namespace Patterns
{
    ...
    constexpr const char* ReceiveUniqueIdRepl2 = "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 50 48 8B F9 33 F6 48 8B 4A 08 48 8B DA 48 85 C9 74 1A 48 8B 01 FF 50 18";

    constexpr const char* CallPreReplication = "48 85 D2 0F 84 ? ? ? ? 56 41 56 48 83 EC 38 4C 8B F2 48 89 5C 24 ? 48 89 6C 24 ? 48 8D 54 24 ? 48 8B F1";
    ...
    constexpr const char* TickFlush2 = "4C 8B DC 55 49 8D AB ? ? ? ? 48 81 EC ? ? ? ? 45 0F 29 43 ? 45 0F 29 4B ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ?";
    ...
    constexpr const char* ReplicateActor2 = "40 55 56 41 54 41 55 41 56 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 4C 8B E9 48 8B 49 68";
    constexpr const char* SetChannelActor = "48 8B C4 55 53 48 8D A8 ? ? ? ? 48 81 EC ? ? ? ? 48 89 70 ? 48 8B D9 48 89 78";
    ...
    constexpr const char* InternalTryActivateAbility = "4C 89 4C 24 ? 4C 89 44 24 ? 89 54 24 10 55 53 56";
