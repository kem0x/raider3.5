...
static void InitInventory(AFortPlayerController* PlayerController)
{
    ...
    static std::vector<UFortWorldItemDefinition*> Items = {
        ...
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataBottleRockets.AmmoDataBottleRockets"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataBotTurret.AmmoDataBotTurret"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataBulletsHeavy.AmmoDataBulletsHeavy"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataBulletsLight.AmmoDataBulletsLight"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataBulletsMedium.AmmoDataBulletsMedium"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataEnergyCell.AmmoDataEnergyCell"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataFragGrenades.AmmoDataFragGrenades"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataFragments.AmmoDataFragments"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataGlowTorch.AmmoDataGlowTorch"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataM80.AmmoDataM80"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataProximityMine.AmmoDataProximityMine"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataProximityMines.AmmoDataProximityMines"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataShells.AmmoDataShells"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataSmokeBomb.AmmoDataSmokeBomb"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoDataThrowingStar.AmmoDataThrowingStar"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoInfinite.AmmoInfinite"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoInfiniteCrossbow_Athena.AmmoInfiniteCrossbow_Athena"),
        UObject::FindObject<UFortAmmoItemDefinition>("FortAmmoItemDefinition AmmoTrollData.AmmoTrollData"),
    };
